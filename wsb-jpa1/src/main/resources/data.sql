...
VALUES (2, 'New York', '123 Main St', NULL, '10001');

INSERT INTO address (id, city, address_line1, address_line2, postal_code)
VALUES (3, 'New York', '123 Main St', NULL, '10001');
insert into patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id)
values (1, 'John', 'Doe', '1234567890', 'john.doe@example.com', 'P001', '1990-01-01', 1),
       (2, 'Jane', 'Smith', '9876543210', 'jane.smith@example.com', 'P002', '1985-05-15',2);

INSERT INTO doctor (id, first_name, last_name, telephone_number, email, doctor_number, specialization, address_id)
VALUES (1, 'John', 'Doctor', '1234567890', 'john.doctor@example.com', 'D001', 'CARDIOLOGY', 3),
       (2, 'Jane', 'Doctor', '9876543210', 'jane.doctor@example.com', 'D002', 'DERMATOLOGY', 3);
